...
try:
    ...
    msg = ("It appears that certain dependencies required for the DRAIN plugin were not detected. "
            ...
            "The following packages were correctly imported: {0}")
...
class Drain(QObject):
    ...
    def unload(self, hide_gw_button=None):
        ...
        try:
            ...
            msg_params = ("global_vars.project_vars",)
        ...
        try:
            ...
            msg_params = ("currentLayerChanged",)
            tools_log.log_info(message, parameter=str(e), msg_params=msg_params)

        try:
            tools_dr.disconnect_signal('layer_changed')
        except Exception as e:
            msg_params = ("layer_changed",)
            tools_log.log_info(message, parameter=str(e), msg_params=msg_params)
        ...
        try:
            ...
            msg_params = ("global_vars.logger.close_logger()",)
            tools_log.log_info(msg, parameter=str(e), msg_params=msg_params)
        ...
        try:
            ...
            msg = "Exception in unload when deleting {0}"
        ...
        try:
            ...
            msg = "Couldn't unload the processing provider"
    ...
    def _manage_user_config_folder(self, user_folder_dir):
        ...
        try:
            ...
            tools_log.log_warning(msg, parameter=str(e), msfg_params=msg_params)
