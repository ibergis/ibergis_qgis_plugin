...
def add_horizontal_spacer():
    ...
    widget = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
    return widget
...
def add_layer_to_toc(layer, group=None, sub_group=None, create_groups=False, sub_sub_group=None):
    ...
    if create_groups:
        ...
        if sub_group is not None and not tools_qgis.find_toc_group(first_group, sub_group):
