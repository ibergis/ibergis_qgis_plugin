...
class DrSchemaI18NUpdate:
    ...
    def _populate_cmb_language(self):
        ...
        language = tools_dr.get_config_parser('i18n_generator', 'qm_lang_language', "user", "session", False)
    ...
    def _save_user_values(self):
        ...
        py_msg = False
        db_msg = False
        tools_dr.set_config_parser('i18n_generator', 'qm_lang_host', f"{host}", "user", "session", prefix=False)
        tools_dr.set_config_parser('i18n_generator', 'qm_lang_port', f"{port}", "user", "session", prefix=False)
        tools_dr.set_config_parser('i18n_generator', 'qm_lang_db', f"{db}", "user", "session", prefix=False)
        tools_dr.set_config_parser('i18n_generator', 'qm_lang_user', f"{user}", "user", "session", prefix=False)
        tools_dr.set_config_parser('i18n_generator', 'qm_lang_language', f"{language}", "user", "session", prefix=False)
        tools_dr.set_config_parser('i18n_generator', 'qm_lang_py_msg', f"{py_msg}", "user", "session", prefix=False)
        tools_dr.set_config_parser('i18n_generator', 'qm_lang_db_msg', f"{db_msg}", "user", "session", prefix=False)
    ...
    def _load_user_values(self):
        ...
        host = tools_dr.get_config_parser('i18n_generator', 'qm_lang_host', "user", "session", False)
        port = tools_dr.get_config_parser('i18n_generator', 'qm_lang_port', "user", "session", False)
        db = tools_dr.get_config_parser('i18n_generator', 'qm_lang_db', "user", "session", False)
        user = tools_dr.get_config_parser('i18n_generator', 'qm_lang_user', "user", "session", False)
        py_msg = tools_dr.get_config_parser('i18n_generator', 'qm_lang_py_msg', "user", "session", False)
        db_msg = tools_dr.get_config_parser('i18n_generator', 'qm_lang_db_msg', "user", "session", False)
