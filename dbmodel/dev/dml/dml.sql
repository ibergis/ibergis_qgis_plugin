...
(47, 'inp_timeseries_timser_type', 'EVAPORATION', 'EVAPORATION', NULL),
(48, 'inp_timeseries_timser_type', 'INFLOW HYDROGRAPH', 'INFLOW HYDROGRAPH', NULL),
(49, 'inp_timeseries_timser_type', 'ORIFICE', 'ORIFICE', NULL),
(50, 'inp_timeseries_timser_type', 'OTHER', 'OTHER', NULL),
(51, 'inp_timeseries_timser_type', 'TEMPERATURE', 'TEMPERATURE', NULL),
(52, 'inp_timeseries_times_type', 'ABSOLUTE', 'ABSOLUTE', NULL),
(53, 'inp_timeseries_times_type', 'FILE', 'FILE', NULL),
(54, 'inp_timeseries_times_type', 'RELATIVE', 'RELATIVE', NULL),
(55, 'inp_curve_type', 'CONTROL', 'CONTROL', '{"header": ["Value", "Setting"]}'),
(56, 'inp_curve_type', 'DIVERSION', 'DIVERSION', '{"header": ["Inflow", "Outflow"]}'),
(57, 'inp_curve_type', 'PUMP1', 'PUMP1', '{"header": ["Volume", "Flow"]}'),
(58, 'inp_curve_type', 'PUMP2', 'PUMP2', '{"header": ["Depth", "Flow"]}'),
(59, 'inp_curve_type', 'PUMP3', 'PUMP3', '{"header": ["Head", "Flow"]}'),
(60, 'inp_curve_type', 'PUMP4', 'PUMP4', '{"header": ["Depth", "Flow"]}'),
(61, 'inp_curve_type', 'RATING', 'RATING', '{"header": ["Head", "Outflow"]}'),
(62, 'inp_curve_type', 'SHAPE', 'SHAPE', '{"header": ["Depth/\nFull Depth", "Width/\nFull Depth"]}'),
(63, 'inp_curve_type', 'STORAGE', 'STORAGE', '{"header": ["Depth", "Area"]}'),
