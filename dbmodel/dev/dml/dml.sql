...
(52, 'inp_timeseries_type', 'OTHER', 'OTHER', NULL),
(53, 'inp_timeseries_timestype', 'ABSOLUTE', 'ABSOLUTE', NULL),
(54, 'inp_timeseries_timestype', 'FILE', 'FILE', NULL),
(55, 'inp_timeseries_timestype', 'RELATIVE', 'RELATIVE', NULL),
(56, 'inp_curve_type', 'CONTROL', 'CONTROL', '{"header": ["Value", "Setting"]}'),
(57, 'inp_curve_type', 'DIVERSION', 'DIVERSION', '{"header": ["Inflow", "Outflow"]}'),
(58, 'inp_curve_type', 'PUMP1', 'PUMP1', '{"header": ["Volume", "Flow"]}'),
(59, 'inp_curve_type', 'PUMP2', 'PUMP2', '{"header": ["Depth", "Flow"]}'),
(60, 'inp_curve_type', 'PUMP3', 'PUMP3', '{"header": ["Head", "Flow"]}'),
(61, 'inp_curve_type', 'PUMP4', 'PUMP4', '{"header": ["Depth", "Flow"]}'),
(62, 'inp_curve_type', 'RATING', 'RATING', '{"header": ["Head", "Outflow"]}'),
(63, 'inp_curve_type', 'SHAPE', 'SHAPE', '{"header": ["Depth/\nFull Depth", "Width/\nFull Depth"]}'),
(64, 'inp_curve_type', 'STORAGE', 'STORAGE', '{"header": ["Depth", "Area"]}'),
(65, 'inp_curve_type', 'TIDAL', 'TIDAL', '{"header": ["Hour", "Stage"]}'),
(66, 'inp_typevalue_pattern', 'DAILY', 'DAILY', NULL),
(67, 'inp_typevalue_pattern', 'HOURLY', 'HOURLY', NULL),
(68, 'inp_typevalue_pattern', 'WEEKEND', 'WEEKEND', NULL),
(69, 'inp_typevalue_pattern', 'MONTHLY', 'MONTHLY', NULL);