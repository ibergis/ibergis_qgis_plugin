...
db_qsql = None                          # Instance of class QSqlDatabase (QSQLITE) used to manage QTableView widgets
...
gpkg_dao = None                         # Instance of class GwGpkgDao. Found in "/lib/tools_gpkg.py"
